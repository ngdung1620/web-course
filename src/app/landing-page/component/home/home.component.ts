...
import {LeaningService} from "../../../learning/services/leaning.service";
...
export class HomeComponent implements OnInit {
  listCombinedCourse: CombinedCourseRespone[] = [];
  listImg = [
    {
  ...
  selectedIndex = 0;
  constructor(private landingService: LandingServiceService, private learningService: LeaningService, private router: Router) { }
  ...
  ngOnInit(): void {
    this.landingService.getListCombinedCourse().subscribe(res =>{
     this.listCombinedCourse = res;
    });
  }


  HandleCourse(id: string) {
    this.learningService._idCourseSubject.next(id);
